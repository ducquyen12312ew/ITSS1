-- =============================================
-- Kodomo Weekend Navi - Seed Data (Dữ liệu mẫu)
-- =============================================
...
-- =============================================
-- 5. SPOT_IMAGES (Hình ảnh địa điểm)
-- =============================================
...
-- =============================================
-- 6. SPOT_FACILITIES (Tiện nghi địa điểm)
-- =============================================
...
-- =============================================
INSERT INTO weather_conditions (date, location, condition, temperature, fetched_at) VALUES
...
-- =============================================
-- Cập nhật lại average_rating và total_reviews
-- =============================================
UPDATE spots s
SET 
    average_rating = (SELECT AVG(rating) FROM reviews WHERE spot_id = s.spot_id AND is_hidden = FALSE),
    total_reviews = (SELECT COUNT(*) FROM reviews WHERE spot_id = s.spot_id AND is_hidden = FALSE);

-- =============================================
-- COMPLETE! Seed data inserted successfully
-- =============================================
